...
function normalizeAuthorizedSemanticCorrections(prs) {
  ...
  if (lb018pre) {
    const expected = {
      writable_paths: [".coding-tools/**", ".gitignore", ".gitattributes", "LICENSE", "README.md", "SECURITY.md", "CONTRIBUTING.md", ".github/**", "scripts/public-release/**", "tests/integration/release-preflight/**", "docs/05_MAINTENANCE_RELEASE.md", "docs/09_RELEASE_CHECKLIST.md", "THIRD_PARTY_NOTICES.md", "release-artifacts/preflight/**"],
      forbidden_paths: ["src/**", "src-tauri/src/**", "runtime/**"],
      required_artifacts: [
        "generated local coding-tool performance task-history and task-state files remain local-only untracked ignored state and are absent from public source",
      ...
      required_tests: [
        "tracked source contains no .coding-tools generated performance task-history or task-state files while local ignored copies may remain on disk",

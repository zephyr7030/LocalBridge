...
assert.equal(hasExactSchema42WindowsExecutionPolicyAmendment20260818(schema42Contracts), true);
const schema42WindowsDrift=structuredClone(schema42Contracts); schema42WindowsDrift.rules.full_descendant_process_system_management_blocking_not_claimed_without_os_confinement=false; assert.equal(hasExactSchema42WindowsExecutionPolicyAmendment20260818(schema42WindowsDrift),false);
const schema42DashboardContracts = normalizeSchema42WindowsExecutionPolicyAmendment20260818(schema42Contracts);

...
assert.equal(hasExactSchema42ToolboxAmendment20260818(schema42Contracts), true);
...
const schema42WindowsContracts = normalizeSchema42ToolboxAmendment20260818(schema42Contracts);

...
assert.equal(hasExactSchema42DashboardObservabilityAmendment20260818(schema42Contracts), true);
const schema42DashboardDrift=structuredClone(schema42Contracts); schema42DashboardDrift.rules.dashboard_last_activity_prefix="上次执行工具："; assert.equal(hasExactSchema42DashboardObservabilityAmendment20260818(schema42DashboardDrift),false);
const schema42BaseContracts = normalizeSchema42DashboardObservabilityAmendment20260818(schema42Contracts);

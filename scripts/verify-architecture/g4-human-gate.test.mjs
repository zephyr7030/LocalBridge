...
assert.equal(hasExactSchema42TaskCommandTruth20260818(schema42Contracts), true);
const schema42Drift=structuredClone(schema42Contracts); schema42Drift.rules.command_summary_derived_from_structured_status=false; assert.equal(hasExactSchema42TaskCommandTruth20260818(schema42Drift),false);
const schema41Contracts = normalizeSchema42TaskCommandTruth20260818(schema42Contracts);

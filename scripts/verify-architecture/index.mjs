...
if (rulesDoc.schema_version !== 11 || !Array.isArray(rulesDoc.rules) || rulesDoc.rules.length !== 34) throw new Error("architecture rule inventory must be schema 11 with exactly 34 rules");

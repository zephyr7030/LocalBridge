...
if (rulesDoc.schema_version !== 10 || !Array.isArray(rulesDoc.rules) || rulesDoc.rules.length !== 29) throw new Error("architecture rule inventory must be schema 10 with exactly 29 rules");

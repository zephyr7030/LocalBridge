...
if (dashboardBeforeSettings.includes('>权限模式</span>') || dashboardBeforeSettings.includes('accessText[projection.permission]')) throw new Error("LB-015 Dashboard still exposes PermissionMode");
if (!dashboardBeforeSettings.includes('>管理员权限</span>') || !dashboardBeforeSettings.includes('privilegeText[projection.privilege]')) throw new Error("LB-015 Dashboard read-only PrivilegeState projection missing");

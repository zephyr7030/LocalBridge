...
for (const required of ["auto_start_services", "onboarding_complete", "ManualStopLatched", "to_control_state(&WorkspaceValidator)", "start_production_runtime", "request_without_uac"])
...
console.log("LB014_CONTRACT=PASS single_instance_pre_tauri=true wake_existing=true hkcu_run=true background_arg=true manual_stop_persistent=true workspace_revalidated=true elevated_requested_no_uac=true preauth_pending=1");

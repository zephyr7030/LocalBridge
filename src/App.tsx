...
import { accessText, currentActivityDetail, currentActivityElapsed, currentActivityText, formatLastToolAge, lastActivityAction, lastActivityOutcome, permissionReconciliationText, projectionStatusText, serviceText, uiText, updateStatusText, workspaceDisplayText } from "./presentation";

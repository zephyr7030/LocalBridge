...
macro_rules! localbridge_invoke_handler {
    ($($extra:path),* $(,)?) => {
        tauri::generate_handler![
            ...
            commands::ui::begin_admin_consent,
            commands::ui::cancel_admin_consent,
            commands::ui::confirm_admin_consent,
            ...
            commands::activity::wait_activity_change,
            commands::confirmation::get_pending_confirmations,
            commands::confirmation::wait_pending_confirmations_change,
            commands::confirmation::approve_administrator_command,
            commands::confirmation::reject_administrator_command,

    ...
    events
        ...
        .map(|start| {
            ...
            ActivityEntry {
                ...
                connection_id: Some(start.connection_id.clone()),
                attempt: Some(start.attempt),
                phase: end.and_then(|end| end.phase.clone()),
                cause: end.and_then(|end| end.cause.clone()),
                http_status: end.and_then(|end| end.http_status),
                workdir: None,
